...
---
```{r predrscors, tab.cap=paste0("Candidate predictor",ifelse(get_nbr_of_predrs(results_ls, as_words_1L_lgl = F)>1,"s",""), " distribution parameters and correlations with AQoL-6D utility"), tab.id = 'predrscors', results="asis"}
...
# }else{
#   tb <- tb %>% 
# transform_tb_for_merged_col_1(output_type_1L_chr = params$output_type_1L_chr)
