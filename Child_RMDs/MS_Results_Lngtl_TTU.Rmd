...
`r make_lngl_ttu_with_covars_text(results_ls)`<!-- Table start --><!-- Comment - need to make the following tables conditional on covariates being evaluated -->`r make_covar_ttu_tbl_refs(params)`<!-- Table end -->. 
